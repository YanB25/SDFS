...
\newcommand{\hmwkTitle}{分布式期末项目\ \#SDFS分布式文件系统} % Assignment title
\newcommand{\hmwkDueDate}{Wednesday,\ January\ 9,\ 2018} % Due date
\newcommand{\hmwkClass}{16级计科\ 7班} % Course/class
\newcommand{\hmwkClassTime}{周一 9-10节} % Class/lecture time
\newcommand{\hmwkClassInstructor}{陈鹏飞} % Teacher/lecturer
...
\begin{minipage}{0.28\textwidth}
    \centering
    \includegraphics[width=\linewidth]{assets/data-Trie.png}
\end{minipage}\hfill
\begin{minipage}{0.28\textwidth}
    \centering
    \includegraphics[width=\linewidth]{assets/data-Trie2.png}
\end{minipage}
